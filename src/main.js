...
`;
      ...
      const startText = state.isMobile ?
        'When you click <strong>Continue</strong>, the task will fill your screen. When you\'re finished, click <em>I\'m finished — Continue</em>.' :
...
`;
      ...
      const loadTimeout = setTimeout(() => {
        ...
        note.textContent = state.isMobile
          ? 'Still loading… if nothing appears soon, try closing and reopening the task.'
          : 'Still loading… if nothing appears soon, try exiting fullscreen and re-entering.';
